...
const swaggerTemplate = require("../../../generator");
...
const clientGeneratedCode = swaggerTemplate.generate(petstoreSwagger, templateClientFile, {clientName: "PetStoreClient"});

const imports = 'import { HttpService, Injectable } from "@nestjs/commun";\nimport * as uriTemplates from "uri-templates";';
fs.writeFileSync("./swagger/petstore.client.generated.ts", imports + "\n\n" + typesGeneratedCode + "\n\n" + clientGeneratedCode);
